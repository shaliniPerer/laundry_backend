 ...
 */
async function sendGetApi(phone, message, senderId) {
...
async function sendGeneric(phone, message, senderId) {
...
async function sendTwilio(phone, message, senderId) {
...
async function sendNotifyLk(phone, message, senderId) {
...
class SmsGateway {
    ...
    async send(phone, message, opts = {}) {
        ...
        try {
            switch (provider) {
                case "getapi":
                    result = await sendGetApi(normalizedPhone, message, senderId);
                    break;
                case "twilio":
                    result = await sendTwilio(normalizedPhone, message, senderId);
                    break;
                case "notifylk":
                    result = await sendNotifyLk(normalizedPhone, message, senderId);
                    break;
