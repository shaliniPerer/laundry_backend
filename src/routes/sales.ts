...
salesRouter.post("/pos", async (req: AuthedRequest, res) => {
  ...
  const rec: SaleRecord = {
    ...
    otherChargeItems: Array.isArray((body as any).otherChargeItems) ? (body as any).otherChargeItems : undefined,
...
salesRouter.put("/:id", async (req: AuthedRequest, res) => {
  ...
  const updates: Partial<SaleRecord> = {
    ...
    otherChargeItems: Array.isArray((body as any).otherChargeItems) ? (body as any).otherChargeItems : existing.otherChargeItems,
    discountOnAll,
